...
class AdapterBowler(private val userList:List<DataStoreTable>,private val context:Context):RecyclerView.Adapter<AdapterBowler.ViewHolderClass>() {
...
//            img_profile_dp.setImageBitmap(userList[position].img)
